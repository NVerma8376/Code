...
class TextEditor:
    ...
    def open_file(self):
        global file
        file = filedialog.askopenfilename(defaultextension=".chapri", filetypes=[("Chapri Files", "*.chapri"), ("All Files", "*.*"), ("Python", "*.py")])
        if file:
    ...
    def save_file(self):
        global file
        file = filedialog.asksaveasfilename(defaultextension=".chapri", filetypes=[("Chapri Files", "*.chapri"), ("All Files", "*.*"), ("Python", "*.py")])
        if file:
